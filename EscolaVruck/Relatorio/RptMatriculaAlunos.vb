...
Public Class RptMatriculaAlunos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EscolaVruck.RptMatriculaAlunos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_semestre() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptMatriculaAlunos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMatriculaAlunos = New RptMatriculaAlunos()
        rpt.Site = Me.Site
        Return rpt
    End Function
